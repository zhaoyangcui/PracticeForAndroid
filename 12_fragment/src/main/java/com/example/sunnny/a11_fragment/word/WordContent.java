package com.example.sunnny.a11_fragment.word;
...
public class WordContent {
    ...
    static {
        ...
        addItem(new WordItem("1","Red","color:red"));
        addItem(new WordItem("2","Blue","color:blue"));
        addItem(new WordItem("3","Green","color:green"));
